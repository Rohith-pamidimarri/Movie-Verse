                                                    ...
                                                    <div class="section text-center">
                                                        ...
                                                        <form action="index.php" method="POST">
                                                                ...
                                                                <div class="form-group mt-2">
                                                                    ...
                                                                    <i class="input-icon fa-solid fa-lock"></i>
                                                                    <!-- <i class="fa-solid fa-eye eye1" id="togglePassword"></i> -->

                                                                 </div>
                                                                <div class="form-group mt-2">
                                                                    <input type="password" name="logpass1" class="form-style" placeholder="Confirm your Password" id="logpass" autocomplete="off" required>
                                                                    <i class="input-icon fa-solid fa-lock"></i>
                                                                </div>
